...
<h2>Description</h2>
 <b> Designed and deployed a multi-phase, production-simulated enterprise environment. This lab replicates the full lifecycle of corporate IT operations: from foundational networking and Active Directory to high-availability storage, PKI security, and server migrations. <br />
 <h2> </h2>
 <b> Learning Material and Project Execution Timeline: 10/2025 - 5/2026 <br />
...
- <b>  Security: AD CS (PKI), NPS (RADIUS), PowerShell Script Block Logging GPO. </b> 
